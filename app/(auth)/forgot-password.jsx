import { View, Text, Image, ImageBackground, TextInput, TouchableOpacity, Alert, StyleSheet, SafeAreaView } from 'react-native'
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await axios.post(
        'https://1c32-103-18-0-19.ngrok-free.app/api/users/forgotPassword', // Replace with your actual backend URL
        { email, newPassword }
      )
