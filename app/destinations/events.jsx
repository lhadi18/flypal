...
const Events = () => {
    ...
    const fetchBookmarksAndEvents = async () => {
      try {
        ...
        const eventsResponse = await axios.get(
          'https://d9c6-2001-e68-5472-cb83-c431-d935-eca7-1ca0.ngrok-free.app/api/events/getEvents',
          {
            params: {
  ...
  const toggleBookmark = async (id, eventDetails) => {
    try {
      ...
      await axios.post(`https://d9c6-2001-e68-5472-cb83-c431-d935-eca7-1ca0.ngrok-free.app/api/bookmarks/${endpoint}`, {
        userId,
        eventId: id,
