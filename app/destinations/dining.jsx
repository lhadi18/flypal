...
const Dining = () => {
  ...
  useEffect(() => {
    const fetchBookmarks = async () => {
      try {
        ...
        const response = await fetch(`https://5b0a-47-128-181-39.ngrok-free.ap/api/bookmarks/user/${userId}`)
        if (response.ok) {
  ...
  const toggleBookmark = async (
    ...
    try {
      ...
      await fetch(`https://5b0a-47-128-181-39.ngrok-free.ap/api/bookmarks/${endpoint}`, {
        method: 'POST',
        headers: {
