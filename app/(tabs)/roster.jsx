...
const Roster = () => {
  ...
  const fetchRosterEntries = async startDate => {
    ...
    if (isConnected) {
      ...
      //     'https://028d-103-18-0-19.ngrok-free.app/api/roster/getRosterEntries',
      //     {
      //       params: {
      //         userId,
    ...
    try {
      if (editMode) {
        if (isConnected) {
          ...
          //   `https://028d-103-18-0-19.ngrok-free.app/api/roster/updateRosterEntry/${editEventId}`,
          //   eventEntry
          // )
        ...
        if (isConnected) {
          ...
          //   'https://028d-103-18-0-19.ngrok-free.app/api/roster/createRosterEntry',
          //   eventEntry
          // )
  ...
  //   try {
  //     const response = await axios.get(
  //       'https://028d-103-18-0-19.ngrok-free.app/api/airport/getAirportByCode',
  //       { params: { code } }
  //     )
  ...
  const uploadFile = async file => {
    ...
    try {
      ...
      const response = await axios.post('https://028d-103-18-0-19.ngrok-free.app/api/pdf/upload', formData, {
        headers: {
