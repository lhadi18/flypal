...
const Roster = () => {
  ...
  const fetchRosterEntries = async startDate => {
    ...
    if (isConnected) {
      ...
      //     'https://7d17-2001-e68-5472-cb83-c4f6-c7c0-affd-aecd.ngrok-free.app/api/roster/getRosterEntries',
      //     {
      //       params: {
      //         userId,
    ...
    try {
      if (editMode) {
        if (isConnected) {
          ...
          //   `https://7d17-2001-e68-5472-cb83-c4f6-c7c0-affd-aecd.ngrok-free.app/api/roster/updateRosterEntry/${editEventId}`,
          //   eventEntry
          // )
        ...
        if (isConnected) {
          ...
          //   'https://7d17-2001-e68-5472-cb83-c4f6-c7c0-affd-aecd.ngrok-free.app/api/roster/createRosterEntry',
          //   eventEntry
          // )
  ...
  //   try {
  //     const response = await axios.get(
  //       'https://7d17-2001-e68-5472-cb83-c4f6-c7c0-affd-aecd.ngrok-free.app/api/airport/getAirportByCode',
  //       { params: { code } }
  //     )
  ...
  const uploadFile = async file => {
    ...
    try {
      ...
      const response = await axios.post('https://7d17-2001-e68-5472-cb83-c4f6-c7c0-affd-aecd.ngrok-free.app/api/pdf/upload', formData, {
        headers: {
