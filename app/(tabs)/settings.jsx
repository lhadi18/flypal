...
const Settings = () => {
  ...
  const fetchUserDetails = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://4690-103-18-0-19.ngrok-free.app/api/users/getUserId`, {
        params: {
          userId
        }
      })
  ...
  const updateUserDetails = async () => {
    ...
    try {
      const response = await axios.put(
        `https://4690-103-18-0-19.ngrok-free.app/api/users/updateUserId/${currentUserDetails._id}`,
        updatedUserData
      )
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const response = await axios.put(
        `https://4690-103-18-0-19.ngrok-free.app/api/users/updatePassword/${userId}`,
        data
      )
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              await axios.delete(`https://4690-103-18-0-19.ngrok-free.app/api/users/deleteUser/${userId}`)
              router.push('/sign-in')
            } catch (error) {
  ...
  const updateProfilePicture = async uri => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://4690-103-18-0-19.ngrok-free.app/api/users/updateProfilePicture/${userId}`,
        formData,
        {
