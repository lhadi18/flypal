  ...
  const handleCreateChecklist = async () => {
    ...
    try {
      const response = await axios.post(
        'https://4690-103-18-0-19.ngrok-free.app/api/checklist/createChecklist',
        checklistData
      )
  ...
  const fetchChecklists = async () => {
    try {
      ...
      const response = await axios.get(
        `https://4690-103-18-0-19.ngrok-free.app/api/checklist/getChecklist`,
        {
          params: {
            userId
          }
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              await axios.delete(
                `https://4690-103-18-0-19.ngrok-free.app/api/checklist/deleteChecklist/${checklistId}`
              )
  ...
  const handleUpdateChecklist = async () => {
    ...
    try {
      const response = await axios.put(
        `https://4690-103-18-0-19.ngrok-free.app/api/checklist/updateChecklist/${currentChecklist._id}`,
