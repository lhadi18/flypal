...
const Connection = ({ isActive }) => {
  ...
  useEffect(() => {
    ...
    const setupWebSocket = async () => {
      ...
      ws.current = new WebSocket('wss://5b0a-47-128-181-39.ngrok-free.appp') // Replace with your WebSocket URL
  ...
  const fetchFriends = async () => {
    ...
    try {
      const response = await axios.get(`https://5b0a-47-128-181-39.ngrok-free.app/api/users/friendList/${userId}`)
  ...
  const removeFriend = async friendId => {
    try {
      const response = await fetch(`https://5b0a-47-128-181-39.ngrok-free.app/api/users/removeFriend`, {
        method: 'POST',
        headers: {
  ...
  const fetchNonFriends = async () => {
    try {
      const response = await axios.get(
        `https://5b0a-47-128-181-39.ngrok-free.app/api/users/nonFriends/${currentUserId}`
      )
  ...
  const handleSendFriendRequest = async recipientId => {
    ...
    try {
      const response = await axios.post(`https://5b0a-47-128-181-39.ngrok-free.app/api/users/friendRequest`, {
...
const Message = ({ isActive }) => {
  ...
  const fetchConversations = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://5b0a-47-128-181-39.ngrok-free.app/api/messages/conversations/${userId}`)
      console.log(response.data)

      const conversations = response.data

      // Fetch user's private key
      const userKeyResponse = await axios.get(`https://5b0a-47-128-181-39.ngrok-free.app/api/key/keys/${userId}`)
      ...
      const decryptedConversations = await Promise.all(
        conversations.map(async conversation => {
          ...
          const otherPartyKeyResponse = await axios.get(
            `https://5b0a-47-128-181-39.ngrok-free.app/api/key/keys/${otherPartyId}`
          )
  ...
  const deleteConversation = async otherUserId => {
    try {
      const response = await axios.delete('https://5b0a-47-128-181-39.ngrok-free.app/api/messages/delete', {
        data: {
  ...
  useEffect(() => {
    ...
    if (isActive) {
      ws.current = new WebSocket('wss://5b0a-47-128-181-39.ngrok-free.appp')
      ws.current.onmessage = event => {
...
const Request = ({ isActive }) => {
  ...
  const fetchRequests = async () => {
    ...
    try {
      if (userId) {
        const response = await axios.get(`https://5b0a-47-128-181-39.ngrok-free.app/api/users/addFriend/${userId}`)
  ...
  const acceptRequest = async (friendRequestId, friendName) => {
    ...
    try {
      const response = await fetch(`https://5b0a-47-128-181-39.ngrok-free.app/api/users/acceptRequest`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const declineRequest = async friendRequestId => {
    ...
    try {
      const response = await fetch(
        `https://5b0a-47-128-181-39.ngrok-free.app/api/users/declineRequest`, // Replace with your backend URL
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
...
const Social = () => {
  const ws = useRef(new WebSocket('wss://5b0a-47-128-181-39.ngrok-free.appp'))
