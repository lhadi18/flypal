    ...
    _.debounce(async (page, query = '') => {
      ...
      try {
        ...
        const response = await axios.get(
          `https://5b0a-47-128-181-39.ngrok-free.app/api/bookmarks/user/${userId}/events-paginated`,
          {
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              const userId = await SecureStore.getItemAsync('userId')
              await axios.post('https://5b0a-47-128-181-39.ngrok-free.app/api/bookmarks/unbookmark', {
                userId,
