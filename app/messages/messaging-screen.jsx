...
const MessagingScreen = () => {
  ...
  useEffect(() => {
    const initializeKeys = async () => {
      try {
        ...
        const response = await fetch(`https://5b0a-47-128-181-39.ngrok-free.app/api/key/keys/${userId}`, {
          method: 'GET',
        ...
        if (privateKeyStr) {
          ...
          const response = await fetch('https://5b0a-47-128-181-39.ngrok-free.app/api/key/keys', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
  ...
  useEffect(() => {
    const fetchRecipientKey = async () => {
      try {
        const response = await fetch(`https://5b0a-47-128-181-39.ngrok-free.app/api/key/keys/${recipientId}`)
        const data = await response.json()
  ...
  useEffect(() => {
    ...
    const fetchMessages = async () => {
      try {
        const response = await fetch(`https://5b0a-47-128-181-39.ngrok-free.app/api/messages/${userId}/${recipientId}`)
        const data = await response.json()
        setMessages(data)
      } catch (error) {
